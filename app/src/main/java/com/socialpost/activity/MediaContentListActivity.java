...
public class MediaContentListActivity extends BaseActivity<BaseViewModel> {
...
//        Picasso.get().load("https://source.unsplash.com/1600x900/?motivational").into(imageView2);
        Glide.with(this).load("https://source.unsplash.com/1600x900/?motivational").into(imageView2);

        String mainId=getIntent().hasExtra(Constants.MAIN_JOINT_CATEGORY_ID)?getIntent().getStringExtra(Constants.MAIN_JOINT_CATEGORY_ID):"";
        ...
        getViewModel().getPoetryData(mainId);
