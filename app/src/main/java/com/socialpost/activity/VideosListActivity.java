...
public class VideosListActivity extends BaseVideoListActivity<BaseViewModel> {
    ...
    public void playVideos(BaseMediaContentPojo mediaContentPojo, int position) {
        ...
        Intent intent=new Intent(VideosListActivity.this, PlayVideoActivityLandscape.class);
